// Vercel Function — admin-side Civil ID image upload.
//
...
//
// Images here are temporary: cleanup-civil-ids.js deletes them 7 days after
...
module.exports = async (req, res) => {
  ...
  if (kind !== 'tenant' && kind !== 'guarantor') return response(res, 400, { error: 'Invalid kind' });
